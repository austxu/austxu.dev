...
export const metadata: Metadata = { title: "Coup", description: "A quiet production shell for Austin Xu's Coup research demo.", alternates: { canonical: "https://austxu.dev/coup" } };
